...
<section>
  <div
    class="bg-grid-2 mb-56 bg-[size:250%] bg-no-repeat text-center text-gray-1 bg-[50%_-10%] md:mb-44 md:bg-contain"
  >
    <div
    ...
    <div
      class="before:content-plus-detail-2 xl:after:content-trophy relative before:absolute before:-bottom-36 before:left-0 before:right-0 xl:before:bottom-0 xl:before:left-20 xl:before:right-auto xl:after:absolute xl:after:-top-14 xl:after:right-44"
    >
      <h2
        class="mx-auto mb-9 mt-10 md:my-12 max-w-xs font-tasa-orbiter-display text-3xl font-medium md:max-w-lg md:text-[2.5rem] md:leading-[3rem]"
      >
