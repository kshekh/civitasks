...
<section>
  ...
  <div class="max-w-6xl mx-auto px-6 sm:mb-24 md:mb-48">
    <div class="mb-20 md:mb-10">
      ...
      <div class="flex items-center justify-between relative">
        ...
        <img
          class="absolute -bottom-1/2 sm:bottom-1/2 sm:translate-y-1/2 right-0 w-32 sm:w-auto sm:block"
          src="/element-globes.svg"
          alt=""
        />
      </div>
    </div>
    ...
    <div>
      ...
      >
        {#each ecosystems as ecosystemItem}
          <li>
            <ImageBox {ecosystemItem} />
          </li>
        {/each}
      </ul>
    </div>
