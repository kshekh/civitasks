		...
		<div class="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-16 md:gap-y-0 md:gap-x-12">
			<div>
				...
				<ul class="grid gap-4">
					<li>
						<a
							class="hover:text-brand-light-green focus-within:text-brand-light-green transition-colors duration-300"
							href="/#">Hackathon</a
						>
					</li>
					<li>
			...
			<div>
				<h2 class="text-gray-400 mb-6 md:mb-8">Get Started</h2>
				<ul class="grid gap-4">
					<li>
						<a
							class="hover:text-brand-light-green focus-within:text-brand-light-green transition-colors duration-300"
			...
			<div>
				<h2 class="text-gray-400 mb-6 md:mb-8">Organization</h2>
				<ul class="grid gap-4">
					<li>
						<a
							class="hover:text-brand-light-green focus-within:text-brand-light-green transition-colors duration-300"
			...
			<div>
				<h2 class="text-gray-400 mb-6 md:mb-8">Legal</h2>
				<ul class="grid gap-4">
					<li>
						<a
							class="hover:text-brand-light-green focus-within:text-brand-light-green transition-colors duration-300"
