...
<div class="pt-0 sm:pt-20 flex justify-center">
	<CornerSquare class="w-full sm:w-[420px] ">
		...
		<div class="w-full py-xl px-2xl">
			<Notification positive title="Your account has been activated." class="w-full">
				<Button secondary size="sm" class="w-full" on:click={() => goto('/projects')}
					>GO TO PROJECT SUBMISSION</Button
				>
			</Notification>
		</div>
	</CornerSquare>
